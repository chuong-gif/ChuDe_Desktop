...
namespace Lab_Advanced_Command
{
    public partial class TableForm : Form
    {
        ...
        // Lớp con để lưu Trạng thái cho ComboBox
        private class TableStatus
        {
            public int Value { get; set; } // 0, 1, 2
            public string Display { get; set; } // "Trống", "Có khách"...
        }
        ...
        private void LoadTables()
        {
            ...
            // Dùng SP "Table_GetAll" đã có trong CSDL
            SqlCommand sqlCommand = new SqlCommand("Table_GetAll", sqlConnection);
        ...
        // Dùng SP "Table_InsertUpdateDelete" (đã có trong CSDL)
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            // Cung cấp giá trị (dù là null) cho các tham số không dùng đến
            ...
            catch (SqlException ex)
            {
                ...
                {
                    MessageBox.Show("Lỗi: Không thể xóa bàn này vì đã có hóa đơn liên quan.");
                }
                else
                {
        ...
        private void tsmViewCurrentBill_Click(object sender, EventArgs e)
        {
            ...
            // Dùng SP "Bills_GetUncheckByTableID" đã có sẵn trong CSDL
            SqlConnection sqlConnection = new SqlConnection(connectionString);
            ...
            {
                int currentBillID = Convert.ToInt32(reader["ID"]);
                reader.Close();
                sqlConnection.Close();
